...
//                  startpoint(X,y)  ENDpoint(X,Y)    THICKNESS
...
String Age = "23";
String ContactNumber = "9322943516";
String Email = "vaishu@gmail";
String Location = "Pune";
*/
Customer customer = new Customer(/*Name, Age, ContactNumber, Email, Location*/);
